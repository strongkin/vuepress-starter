...
![1616335492457](./images/index/layout.png)
...
1）准备样式变量文件
 ...
 `src/./images/styles/variables.less`
...
* {
 ...
 img {
   ...
   background: #ebebeb url(.././images/./images/200.png) no-repeat center / contain;
 }
 ul {
   list-style: none;
 }
...
![1616335492457](./images/index/02.png)
...
![1616335492457](./images/index/login-status.png)
...
![1616335520936](./images/index/03.png)
...
.app-header {
  ...
  .logo {
    ...
    a {
      ...
      width: 100%;
      text-indent: -9999px;
      background: url('~@/./images/./images/logo.png') no-repeat center 18px / contain;
    }
  }
  .navs {
    width: 820px;
...
![1616335569363](./images/index/nav.png)
...
![1616335541641](./images/index/04.png)
  ...
  <footer class="app_footer">
    ...
    <div class="contact">
      <div class="container">
        ...
        <dl>
          <dt>下载APP</dt>
          <dd class="qrcode"><img src="@/./images/./images/qrcode.jpg" /></dd>
          <dd class="download">
            <span>扫描二维码</span>
            <span>立马下载APP</span>
...
.app-header-sticky {
  ...
  .logo {
    width: 200px;
    height: 80px;
    background: url('~@/./images/./images/logo.png') no-repeat  right 2px;
